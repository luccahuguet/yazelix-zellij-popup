...
or a `default` popup, no payload is needed. A caller that owns cwd policy can send
...
Toggling a focused popup off or explicitly closing it also hides the current
